...
- upstream source: pinned `.vendor/gut` Git submodule;
- materialized plugin: ignored `res://addons/gut` generated by `tools/bootstrap.sh`;
...
Tests must not depend on unpinned Asset Library state or a contributor's global editor addons.
